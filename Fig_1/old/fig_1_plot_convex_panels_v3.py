...
import numpy as np
import os
convex_inputs_file = '/work/alonh/Missing_structures/Figs/Fig_1/fig_1_convex_inputes.txt'
...
for i,line in enumerate(lines):
  ...
  ax = plot_convex(ax,[input_file],proto_atom,A_atom,title=None,out_file=None,graph_num=1,proto_graph=True,ptable=True,on_convex_only=None)


os.chdir(cwd)
plt.savefig('fig_1_v3.png',dpi=200)
