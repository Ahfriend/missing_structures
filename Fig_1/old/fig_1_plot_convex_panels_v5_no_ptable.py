...
for i,line in enumerate(lines):
  ...
  ax.annotate(text=abc[i],xy =(-0.1,-0.05) ,xycoords='axes fraction',fontsize=10,fontweight='bold',color='black') 
  ...
  plt.annotate(text=A_atom+proto_atom,xy=(0,1.2),xycoords='axes fraction',fontsize=10,fontweight='bold',color = 'black')

####  TiS  #####
  if i == 1:
    axins.annotate("Ti$_{3}$Se$_{4}$", xy=(0.62,-1.654), xytext=(0.8,-1.6),xycoords='data',arrowprops=dict(arrowstyle="->",color='c'),fontsize=8,color='c')

#### CuS  #####
  if i == 0:   
    axins.annotate("Cu$_{3}$Se$_{2}$", xy=(0.37, -0.217), xytext =(-0.05, -0.25),xycoords='data',arrowprops=dict(arrowstyle="->",color='c'),fontsize=8,color='c')


plt.annotate(text='formation energy [eV/Atom]',xy =(0.0,0.33) ,xycoords='figure fraction',fontsize=10,rotation=90,color='black' )
plt.annotate(text='$y$/($x$+$y$)',xy =(0.5,0.01) ,xycoords='figure fraction',fontsize=10,color='black')
