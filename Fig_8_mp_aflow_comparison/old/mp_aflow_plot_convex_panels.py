...
import numpy as np
import os
convex_inputs_file = 'mp_aflow_compare.txt'
...
for i,line in enumerate(lines):
  ...
  ax = plot_convex(ax,[input_file],proto_atom,A_atom,title=None,out_file=None,graph_num=None,proto_graph=True,ptable=False,on_convex_only=True)
