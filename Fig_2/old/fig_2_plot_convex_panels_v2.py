...
from convex_hull_layers_function_12 import plot_convex 
...
for i,line in enumerate(lines):
  ...
  plt.annotate(s=A_atom+proto_atom,xy=(1.3,-2.05),xycoords='axes fraction',fontsize=16,fontweight='bold')



os.chdir(cwd)
plt.savefig('fig_2_v2_dpi_200.png',dpi=200)
