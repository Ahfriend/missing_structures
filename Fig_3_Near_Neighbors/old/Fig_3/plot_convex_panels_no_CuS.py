...
import numpy as np
import os
convex_inputs_file = '/work/alonh/Missing_structures/Figs/Near_Neighbors/convex_inputes.txt'
...
for i,line in enumerate(lines):
  ...
  plot_convex(ax,[input_file],proto_atom,A_atom,title=None,out_file=None,graph_num=3,ptable=True,convex_width=65,leg_pos=(1.4,1.6),near_neighbor=True)

for i in ticks_len:
  print (i)

os.chdir(cwd)
plt.savefig('fig_3_with_CuS_dpi_400.png',dpi=400)
