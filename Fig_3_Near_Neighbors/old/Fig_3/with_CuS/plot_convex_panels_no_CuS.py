...
from convex_hull_layers_function_13 import plot_convex 
import matplotlib as mpl
mpl.use('Agg')
import matplotlib.pyplot as plt
import numpy as np
import os
convex_inputs_file = '/work/alonh/Missing_structures/Figs/Fig_3/convex_inputes_CuS.txt'
...
for i,line in enumerate(lines):
  ...
  plot_convex(ax,[input_file],proto_atom,A_atom,title=None,out_file=None,graph_num=2,ptable=True,convex_width=65,leg_pos=(1.5,1.6))

for i in ticks_len:
  print (i)

os.chdir(cwd)
plt.savefig('fig_3_no_CuS_dpi_200.png',dpi=200)
